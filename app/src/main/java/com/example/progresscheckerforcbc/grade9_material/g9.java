package com.example.progresscheckerforcbc.grade9_material;
...
public class g9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar yb = findViewById(R.id.grade9_toolbar);
        setSupportActionBar(yb);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        LinearLayout ll = findViewById(R.id.net_stateg9);
        ProgressBar hj = findViewById(R.id.g9pb);
...
//                }
//            });
        RecyclerView cr = findViewById(R.id.g9_rv);
        ...
        rv_adapter adapter = new rv_adapter(g9.this,"Grade 9");
        adapter.setSn(sNames);
        cr.setAdapter(adapter);
    }
}