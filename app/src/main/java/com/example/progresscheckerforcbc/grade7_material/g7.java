package com.example.progresscheckerforcbc.grade7_material;
...
public class g7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar yb=findViewById(R.id.grade7_toolbar);
        setSupportActionBar(yb);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        LinearLayout ll=findViewById(R.id.net_stateg7);
        ProgressBar hj=findViewById(R.id.g7pb);
...
//                }
//            });
        RecyclerView cr = findViewById(R.id.g7_rv);
        ...
        rv_adapter adapter = new rv_adapter(g7.this,"Grade 7");
        adapter.setSn(sNames);
        cr.setAdapter(adapter);
