package com.example.progresscheckerforcbc.grade3_material;
...
public class g3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar yb=findViewById(R.id.grade3_toolbar);
        setSupportActionBar(yb);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        LinearLayout ll=findViewById(R.id.net_stateg3);
        ProgressBar hj=findViewById(R.id.g3pb);
...
//                }
//            });
        RecyclerView cr = findViewById(R.id.g3_rv);
        ...
        rv_adapter adapter = new rv_adapter(g3.this,"Grade 3");
        adapter.setSn(sNames);
        cr.setAdapter(adapter);
    }
