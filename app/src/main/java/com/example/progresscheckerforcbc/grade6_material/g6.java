package com.example.progresscheckerforcbc.grade6_material;
...
public class g6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar yb=findViewById(R.id.grade6_toolbar);
        setSupportActionBar(yb);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        LinearLayout ll=findViewById(R.id.net_stateg6);
        ProgressBar hj=findViewById(R.id.g6pb);
...
//                }
//            });
        RecyclerView cr = findViewById(R.id.g6_rv);
        ...
        rv_adapter adapter = new rv_adapter(g6.this,"Grade 6");
        adapter.setSn(sNames);
        cr.setAdapter(adapter);
