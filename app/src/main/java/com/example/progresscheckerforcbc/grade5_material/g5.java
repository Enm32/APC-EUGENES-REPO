package com.example.progresscheckerforcbc.grade5_material;
...
public class g5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar yb=findViewById(R.id.grade5_toolbar);
        setSupportActionBar(yb);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        LinearLayout ll=findViewById(R.id.net_stateg5);
        ProgressBar hj=findViewById(R.id.g5pb);
...
//                }
//            });
        RecyclerView cr = findViewById(R.id.g5_rv);
        ...
        rv_adapter adapter = new rv_adapter(g5.this,"Grade 5");
        adapter.setSn(sNames);
        cr.setAdapter(adapter);
