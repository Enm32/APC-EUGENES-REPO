package com.example.progresscheckerforcbc.grade2_material;
...
public class g2activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g2activity);
        ...
        Toolbar yb=findViewById(R.id.grade2_toolbar);
        setSupportActionBar(yb);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        LinearLayout ll=findViewById(R.id.net_stateg2);
        ProgressBar hj=findViewById(R.id.g2pb);
...
//                }
//            });
        RecyclerView cr = findViewById(R.id.g2_rv);
        ...
        rv_adapter adapter = new rv_adapter(g2activity.this,"Grade 2");
        adapter.setSn(sNames);
        cr.setAdapter(adapter);
