package com.example.progresscheckerforcbc.grade4_material;
...
public class g4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar yb=findViewById(R.id.grade4_toolbar);
        setSupportActionBar(yb);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        LinearLayout ll=findViewById(R.id.net_stateg4);
        ProgressBar hj=findViewById(R.id.g4pb);
...
//                }
//            });
        RecyclerView cr = findViewById(R.id.g4_rv);
        ...
        rv_adapter adapter = new rv_adapter(g4.this,"Grade 4");
        adapter.setSn(sNames);
        cr.setAdapter(adapter);
    }
